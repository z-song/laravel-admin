...
<head>
    ...
    {!! Admin::css() !!}
    <link rel="stylesheet" href="{{ asset("/packages/admin/nestable/nestable.min.css") }}">
    <link rel="stylesheet" href="{{ asset("/packages/admin/toastr/build/toastr.min.css") }}">
    <link rel="stylesheet" href="{{ asset("/packages/admin/bootstrap3-editable/css/bootstrap-editable.min.css") }}">
    <link rel="stylesheet" href="{{ asset("/packages/admin/google-fonts/fonts.min.css") }}">
    ...
    <script src="{{ asset ("/packages/admin/jquery-pjax/jquery.pjax.min.js") }}"></script>
...
<script src="{{ asset ("/packages/admin/nestable/jquery.nestable.min.js") }}"></script>
...
<script src="{{ asset("/packages/admin/laravel-admin/app.min.js") }}"></script>
