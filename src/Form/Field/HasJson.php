...
dd('199');
    ...
    protected function getKeyName()
    {
        ...
        return 'key_hasjson_'.$this->column;
    }
    */
    /**
     * Set view mode.
...
EOT;
    ...
    public function render()
    {
        ...
        //echo "<pre>496 ";var_dump($template);var_dump($script);die();
