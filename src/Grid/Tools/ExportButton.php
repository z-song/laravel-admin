...
<div class="btn-group pull-right" style="margin-right: 10px">
    <a href="{$this->grid->getExportUrl('all')}" target="_blank" class="btn btn-sm btn-twitter" title="{$trans['export']}"><i class="fa-solid fa-download"></i><span class="hidden-xs"> {$trans['export']}</span></a>
