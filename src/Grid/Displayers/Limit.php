...
<div class="limit-text">
    ...
    &nbsp;<a href="javascript:void(0);" class="limit-more">&nbsp;<i class="fa-regular fa-angle-double-down"></i></a>
</div>
<div class="limit-text hide">
    <span class="text">{$original}</span>
    &nbsp;<a href="javascript:void(0);" class="limit-more">&nbsp;<i class="fa-regular fa-angle-double-up"></i></a>
</div>
HTML;
    }
}
