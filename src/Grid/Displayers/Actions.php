...
class Actions extends AbstractDisplayer
{
    ...
    {
        return <<<EOT
<a class="btn btn-xs btn-info" style="margin:1px" title="View" href="{$this->getResource()}/{$this->getKey()}">
    <i class="fa fa-eye"></i>
</a>
EOT;
    }
    ...
    {
        return <<<EOT
<a class="btn btn-xs btn-success" style="margin:1px" title="Edit" href="{$this->getResource()}/{$this->getKey()}/edit">
...
SCRIPT;
        ...
        return <<<EOT
<a style="margin:1px" title="Delete" href="javascript:void(0);" data-id="{$this->getKey()}" class="{$this->grid->getGridRowName()}-delete btn btn-xs btn-danger">
