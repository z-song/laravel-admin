...
use Encore\Admin\Auth\Database\Files as AdminFiles;
...
class Files
{
	...
	public function destroy($key)
	{
		...
		if ($this->storage->exists($model->getAttribute('target'))) {
			$this->storage->delete($model->getAttribute('target'));
		}
	...
	public function getFiles()
	{
		...
		$scope = array_only($this->attributes, ['table', 'parent_id']);

		return $this->model->getFiles($scope)->get();
