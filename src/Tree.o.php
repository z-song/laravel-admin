...
class Tree implements Renderable
{
    ...
    public function isList(){//分级列表模式
        $this->isList = true;
        $this->useAll = true;
        $this->disableCreate();$this->disableSave();$this->disableRefresh();
        $this->setView(['tree'   => 'admin::tree','branch' => 'admin::tree.list',]);
    }
    /**
     * Disable create.
     *
    ...
    protected function script()
    {
        ...
        return ($this->isList?"":"$('#{$this->elementId}').nestable($nestableOptions);\n").<<<SCRIPT
